...
const express = require("express"),
    ...
    imgStorage = require("./storageFunctions");
...
module.exports =
    app.get("/pictures", (req, res) => {
        ...
        if (req.query.compressed === "false") {
            thisimage = { image: "asc" };
            imgDir = imgStorage.getImageDir(false);
        } else {
            imgDir = imgStorage.getImageDir();
        }
        ...
        Product.find({}).sort(thisimage).exec((err, images) => {
            if (err) {
                ...
                console.log(req.query.compressed)
                //console.log(images)
                ...
                //semd the images object to the client to be processed and used for the slideshow
                res.send(images.sort());
            }
        });
    });
